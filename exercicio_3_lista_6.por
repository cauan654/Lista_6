programa
{
	...
	funcao inicio()
	{
		...
		inteiro verifcMaiorNumero = verificacaoMaiorNumero(vetor)
			escreva("O maior numero do vetor é: " + verifcMaiorNumero + "\n")

			inteiro verifcMenorNumero = verificacaoMenorNumero(vetor)
			escreva("O menor numero do vetor é: " + verifcMenorNumero + "\n")

			inteiro somaNumeros = somatorioNumeros(vetor)
			escreva("A soma de todo vetor é: " + somaNumeros + "\n")

			inteiro mediaDosNumeros = mediaNumeros(vetor)
			escreva("A média to vetor é: " + mediaDosNumeros + "\n")
